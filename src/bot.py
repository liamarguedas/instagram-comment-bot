...
class Bot:
    ...
    def login(self, username: str, password: str):
        ...
        try:
            ...
            self.log("login in successfully.")
            time.sleep(5)

            self.log("Reading comments...")
            ...
            self.log("Automation stopped due to an error")
            self.log(str(e))
    ...
    def new_comment_recieved(self):
        ...
        self.log(f"Found {len(comments)} messages")
        return comments
